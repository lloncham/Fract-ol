...
/*   Updated: 2019/02/19 16:52:40 by lloncham         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_info(t_mlx *ptr)
{
	...
	if (ptr->choose == 2)
	{
		...
		mlx_string_put(ptr->mlx, ptr->win, 10, 140, 0xffffff, "Stop / Play : space");
	}
	if (ptr->choose == 3)
	...
	if (ptr->choose == 5)
		mlx_string_put(ptr->mlx, ptr->win, ptr->size_w - 120, ptr->size_h - 30, 0xffffff, "BURNINGSHIP");
